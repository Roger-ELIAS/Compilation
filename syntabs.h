...
struct n_instr_ {
  ...
  union{
	...
	struct{struct n_instr_ *affect; n_exp *test; struct n_instr_ *affect2; struct n_instr_ *faire;} pour_;
    n_appel *appel;
...
/*POUR*/
n_instr *cree_n_instr_pour(n_instr *affect, n_exp *test, n_instr *affect2, n_instr *faire);
